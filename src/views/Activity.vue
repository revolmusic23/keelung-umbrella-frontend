<template>
  ...
  <article class="article">
    <div class="article-container">
      <div class="article-container-title">
        <h4 class="article-container-title-text">活動內容</h4>
      </div>
  ...
  <main class="information">
    <div class="information-container">
      <div class="d-lg-flex justify-space-between align-end gx-6">
        <p>
          ...
          <div class="information-container-prize">
            <h4
            >第 1 名：LEICA 徠卡 SOFORT 2 拍立得相機</h4
          >
          <h4>第 2 名：Polaroid 寶麗來 Now+ G2 拍立得相機套組 <span>( 含 5 種顏色濾鏡 + 底片 )</span></h4
          >
      ...
      <div class="information-container-gift">
        <div class="information-container-gift-left">
          <p>活動<br>好禮</p>
        </div>
        <div class="information-container-gift-right">
          活動期間每日 <span>9:00 - 17:00 於活動現場</span>完成參賽，分享活動網站於個人IG或 FB 並追蹤基隆市文化觀光局 FB ，經現場工作人員確認無誤後，將可獲得活動特製<span>「傘人家族精緻小物」</span>一個（二款隨機贈送，一人限領取一個，每日限量，送完為止）。<span>10/10、10/13、10/14、10/21、10/28</span> 為休館日，無兌換活動，但仍可拍照參賽。
        </div>
      </div>
      ...
      <div class="d-md-flex justify-start align-center mt-12 gx-6">
        ...
        <div class="information-container-content w-md-75 w-100">
          <h3 class="paragraph-title">參賽辦法</h3>
          <ol class="pl-4">
            <li>作品限用手機拍攝，不限手機品牌。</li>
            <li>主題內容不限，唯必須與傘人家族任一成員合照，合照對象不限 (人、竉物、玩偶、玩具…皆可)，但照片內容不可違反公序良俗，如有違背，主辦單位有權下架作品，不另行通知。</li>
            <li>參賽作品需在基隆市文化廣場傘人攝影活動場地拍攝之照片，且同意授權主辦單位於平台宣傳、展示使用權利。</li>
            <li>每人至多可上傳三張照片參賽，每張照片檔案不可小於 1,200 萬畫素，⻑寬⽐為 4:3 的 JPEG 檔。</li>
            <li>作品後製僅限用手機調整明暗對⽐、⾊彩、裁切；禁止數位合成、加字、彩繪、疊片等。</li>
            <li>每張照⽚須附上 50 字以內之敘述，文字內容禁止使用低俗、淫穢、粗鄙等不雅文字，如違反規定，主辦單位有權下架作品，不另行通知。</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="detail-container">
      <div class="d-sm-flex justify-space-between">
        <div class="w-sm-33 w-100 mr-sm-10 mr-0">
          ...
          <div class="detail-container-section">
            <h4 class="detail-container-section-title">收件方式</h4>
            <p class="detail-container-section-content">
              一律於活動網站，上傳作品
            </p>
          </div>
        ...
        <div class="w-sm-66 w-100">
          <div class="detail-container-section">
            ...
            <p class="detail-container-section-content mt-6">
              評分項目
            </p>
      ...
      <div class="detail-container-section">
        <h4 class="detail-container-section-title">得獎公佈</h4>
        <p class="detail-container-section-content">
          <span class="date-text">11/7</span> 將於<span
      ...
      <div class="detail-container-section-content">
        <ol class="pl-4">
          <li>
            基隆市政府 員工、評審及配偶及二親等以內血 姻 親 均 不得參與比賽 ，有違
            反而得獎者，撤銷其參賽與得獎資格。
          </li>
          <li>
          ...
          <li>
            主辦單位保留隨時修正、暫停、終止或解釋本活動之一切及 最 終權利（包括
            但不限於更換活動、提前終止或延長活動時間之 最 終決定權等事項），相關
            內容如有變動將於 比賽 活動 網 站 及 文化觀光局臉書
            另行公告，不另行通知，
            若有任何異動，以本競賽活動官方網站最新公告為準。
          </li>
          <li>
            若得獎獎項價值累計超過新台幣 1,001 元 含 以上者而未滿 1 8 歲之中獎
